...
from mip.data import Method, Result
from mip.data.utils import DataclassJSONEncoder
from mip.manager import ComputeManager, ResultManager, MethodManager
...
class ComputeMethodApplication:
    ...
    def on_post(self, req: Request, resp: Response):
        ...
        # '/data/MIP/datasets/8a3ed58a-28e8-4064-88be-1100f6bb56ad/1fd169e4-c988-4d0d-a803-a3c39d5aedd6')
